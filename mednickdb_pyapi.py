...
class MednickAPI:
    ...
    def login(self, username, password):
        ...
        #TODO i dont really understand how login works, so this will probably change
        self.username = username
        base_str = self.server_address + '/Login?' + 'Username=' + username + '&Password='+password
        return self.s.post(base_str)
    ...
    def get_file_info(self, id):
        ...
        return self.s.get(self.server_address + '/FileInfo?' + 'id=' + id).text
    ...
    def update_file_info(self, id, file_info):
        """Add meta data to a file. file_info should be key:value pairs. already existing keys will be overwriten"""
    ...
    def get_data(self, study=None, version=None, visit=None, session=None, filetype=None):
        ...
        ret = self.s.post(self.server_address + '/Data?'+append_hierarchical_specifiers(study,version,visit,session,filetype))
        return json.loads(ret)

    def get_deleted_data(self, study=None, version=None, visit=None, session=None, filetype=None):
        """Get all the data in the datastore at the specified location. Return is python dictionary"""
        ret = self.s.post(self.server_address + '/DeletedData?'+append_hierarchical_specifiers(study,version,visit,session,filetype))
        return json.loads(ret)
    ...
    def get_filetypes(self, study, version=None, visit=None, session=None, store='File'):
        ...
        return self.s.get(self.server_address + '/FileTypes' +
    ...
    def get_sessions(self, study, version, visit, store='Data'):
        ...
        # TODO implement switch for file or data store
        return self.s.get(self.server_address + '/Sessions?' +
    ...
    def get_visits(self, study, version, store='Data'):
        ...
        Either from data store (default) or file store"""
        # TODO implement switch for file or data store
        return self.s.get(self.server_address + '/Visits?' +
